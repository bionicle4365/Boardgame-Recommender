...
resource "aws_ecr_repository" "bgg_preview_discovery_repo" {
...
resource "aws_ecr_lifecycle_policy" "bgg_preview_discovery_lifecycle" {
  repository = aws_ecr_repository.bgg_preview_discovery_repo.name
...
resource "aws_ecr_repository" "bgg_preview_refresh_repo" {
  name                 = "bgg_preview_refresh"
  image_tag_mutability = "MUTABLE"
...
resource "aws_ecr_lifecycle_policy" "bgg_preview_refresh_lifecycle" {
  repository = aws_ecr_repository.bgg_preview_refresh_repo.name
